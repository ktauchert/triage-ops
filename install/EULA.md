...
By **installing**, **accessing**, or **using** TriageOps (including completing initial setup and signing in), you agree to this Agreement and to the [Privacy Policy](./PRIVACY.md). If you do not agree, do not install or use the software.
...
Processing of personal data is described in the [Privacy Policy](./PRIVACY.md). On-prem deployments generally store data on infrastructure you control; roles and responsibilities depend on your deployment and jurisdiction.
...
Email: developer@ktauchert.de · Web: https://ktauchert.de
