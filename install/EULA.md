...
By **installing**, **accessing**, or **using** Gridnull (including completing initial setup and signing in), you agree to this Agreement and to the [Privacy Policy](./PRIVACY.md). If you do not agree, do not install or use the software.
